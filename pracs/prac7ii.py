...
TimeFrame = pd.DataFrame(columns=['TimeID', 'UTCDate', 'LocalTime', 'TimeZone'])
################################################################
...
PersonFrame = pd.DataFrame(columns=['PersonID', 'FirstName', 'LastName', 'Zone', 'DateTimeValue'])
################################################################
...
PersonTimeFrame = pd.DataFrame(columns=['IDNumber', 'IDPersonNumber', 'IDTimeNumber'])
################################################################
